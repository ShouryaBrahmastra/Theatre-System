/**
 * @file Theatre-Seat-Reservation-C-Pro.cpp
 * @author Shourya Gupta(https://github.com/ShouryaBrahmastra)
 * @brief
 * A basic theatre seat reservation system
 * @version 0.1
 * @date 2022-12-20
 *
...
Show show = {"Avatar 2", "20-12-2022", "20:30", "7"};
...

{
        ...
        printf("\t  THEATRE SEAT RESERVATION\n"
               "\t=============================\n"
               "\tNow Showing: Avatar The Way of Water\n"
               "\t=============================\n"
               "\n\t1=> FOR BOOKINGS\n"
